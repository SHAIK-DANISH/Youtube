...
const registerUser = asyncHandler(async (req, res)=> {
    ...
    const coverImagesLocalPaths= req.files?.coverImages?.path;
    ...
    const coverImagesCloudinary = await uploadOnCloudinary(coverImagesLocalPaths);
    ...
    const user = await User.create({
        ...
        coverImages: coverImagesCloudinary?.url || ""
    })
